...
var getEquivalent_V = function(V0) {//ok
    ...
    return [
        { matrix: V0, permutation: [0,1,2] },
        { matrix: V1, permutation: [1,0,2] },
        { matrix: V2, permutation: [0,2,1] },
        { matrix: V3, permutation: [1,2,0] },
        { matrix: V4, permutation: [2,1,0] },
        { matrix: V5, permutation: [2,0,1] },
    ];
}
...
export function are_VI_Equivalents(arr0, arr1) {
    ...
    let permutation = are_V_Equivalent(V0, V1);
